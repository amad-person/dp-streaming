        ...
        for window_size in plots_config["window_size"]:
            ...
            for run in range(plots_config["num_runs_for_plot"]):
                ...
                if batches_for_plot is not None:
                    nb_true_ans_path += f"_batches{batches_for_plot}"
                ...
                if batches_for_plot is not None:
                    br_true_ans_path += f"_batches{batches_for_plot}"
                ...
                if comparison_type == "all":
                    ...
                    if batches_for_plot is not None:
                        int_true_ans_path += f"_batches{batches_for_plot}"
            ...
            plt.tight_layout()
            plt.savefig(f"{exp_save_dir}/abs_error_vs_batch.png", dpi=1000)
            # plt.show()
